...
namespace LinkRelationsMore.Controllers
{
    ...
    {
        // Attention - This controller answers a URI that ends with 'api'
        ...
        public IHttpActionResult Get()
        {
            ...
            links.Add(new Link() { Rel = "collection", Href = "/api/manufacturers", Method = "GET,POST" });
            links.Add(new Link() { Rel = "collection", Href = "/api/vehicles", Method = "GET,POST" });
            links.Add(new Link() { Rel = "collection", Href = "/api/otherexample", Method = "GET,POST" });
            links.Add(new Link() { Rel = "task", Href = "/api/whatever/taskone", Method = "PUT" });
            links.Add(new Link() { Rel = "task", Href = "/api/whatever/tasktwo", Method = "PUT" });
