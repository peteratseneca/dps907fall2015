...
namespace LinkRelationsMore
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            // Attention - the "controller" default was added to support discovery
            // It enables a requestor to use the URI that ends with "/api",
            // and the pipeline will route the request to the root controller
