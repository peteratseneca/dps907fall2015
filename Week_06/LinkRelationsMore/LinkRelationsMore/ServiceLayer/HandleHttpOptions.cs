...
namespace LinkRelationsMore.ServiceLayer
{
    ...
    {
        public static IEnumerable<string> GetSupportedMethods(string c, string i)
        {
            ...
            var controllerRequested = c;// request.GetRouteData().Values["controller"] as string;
            // Get the value of 'id'
            var idRequested = i;// request.GetRouteData().Values["id"] as string;
