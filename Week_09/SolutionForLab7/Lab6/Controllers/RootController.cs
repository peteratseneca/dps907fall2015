...
namespace Lab6.Controllers
{
    public class RootController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            links.Add(new Link() { Rel = "collection", Href = "/api/exceptions", Method = "GET" });
            links.Add(new Link() { Rel = "collection", Href = "/api/createerror", Method = "GET" });
            links.Add(new Link() { Rel = "collection", Href = "/api/instruments", Method = "GET,POST" });
            links.Add(new Link() { Rel = "task", Href = "/api/instruments/{id}/setphoto", Method = "PUT" });
            links.Add(new Link() { Rel = "task", Href = "/api/instruments/{id}/setsoundclip", Method = "PUT" });
