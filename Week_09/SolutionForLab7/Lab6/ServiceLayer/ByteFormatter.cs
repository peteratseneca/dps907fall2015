...
namespace Lab6.ServiceLayer
{
    ...
    public class ByteFormatter : BufferedMediaTypeFormatter
    {
        ...
        public ByteFormatter()
        {
            ...
            // Attention - A number of new types were added...
            this.SupportedMediaTypes.Add(new MediaTypeHeaderValue("audio/mp3"));
            this.SupportedMediaTypes.Add(new MediaTypeHeaderValue("audio/wav"));
            this.SupportedMediaTypes.Add(new MediaTypeHeaderValue("audio/ogg"));
