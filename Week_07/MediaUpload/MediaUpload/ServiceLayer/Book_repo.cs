...
{
    // Attention - Book entity-specific repository
    ...
    public class Book_repo : Repository<Book>
    {
        ...
        public BookWithMediaInfo GetById(int id)
        {
            // Call the base class method
            var fetchedObject = RGetById(i => i.Id == id, null);

            return (fetchedObject == null) ? null : Mapper.Map<BookWithMediaInfo>(fetchedObject);
        }
