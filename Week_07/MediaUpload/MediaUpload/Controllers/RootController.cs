...
namespace MediaUpload.Controllers
{
    public class RootController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            // Attention - Edited the list of "root" controller links
            List<Link> links = new List<Link>();
            links.Add(new Link() { Rel = "collection", Href = "/api/books", Method = "GET,POST" });
            ...
            links.Add(new Link() { Rel = "task", Href = "/api/books/{id}/setphoto", Method = "PUT" });
