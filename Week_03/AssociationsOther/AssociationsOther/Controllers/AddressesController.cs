...
namespace AssociationsOther.Controllers
{
    public class AddressesController : ApiController
    {
        ...
        public IHttpActionResult Get(int? id)
        {
            ...
            var fetchedObject = m.GetAddressById(id.Value);
        ...
        public IHttpActionResult Post([FromBody]AddressAdd newItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var addedItem = m.AddAddress(newItem);
        ...
        // PUT: api/Addresses/5
        public IHttpActionResult Put(int id, [FromBody]AddressEdit editedItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var changedItem = m.EditAddress(editedItem);
