...
namespace LocalSecurity.Controllers
{
    public class MaintenanceController : Controller
    {
        ...
        // Attention - This method will display a list of current user accounts
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.UserList = accountList;

            return View();
        }

        // Attention - This enables ANYONE to delete an account
        // It is to be used by the programmer only
