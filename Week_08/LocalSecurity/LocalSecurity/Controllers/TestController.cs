...
namespace LocalSecurity.Controllers
{
    ...
    {
        // Attention - This controller enables you to test authentication and role claims
        ...
        // GET: api/Test
        // Anonymous
        // Attention - This method will display all claims for authenticated users
        ...
        // Attention - These methods enable testing of specific role claims
        ...
        [Route("api/test/role/admin")]
        public IEnumerable<string> GetRoleAdmin()
        {
