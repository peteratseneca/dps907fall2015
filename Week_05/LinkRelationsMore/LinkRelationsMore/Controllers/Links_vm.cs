...
namespace LinkRelationsMore.Controllers
{
    ...
    // Attention - The abstract base classes for "linked" objects have been refactored
    ...
    public abstract class LinkedItem<T>
    {
        public LinkedItem(T item)
        {
            ...
            dynamic i = Item;
            i.Link = new Link() { Rel = "self", Href = absolutePath };
        ...
        {
            // Attention - This constructor handles the "add new" use case
